...
<!--/* @open="handleOpen" */-->
  ...
  <div >     
    ...
    <el-menu  class="el-menu-vertical-demo  h-xl"  :unique-opened="true">
      ...
      >              
        ...
        <el-scrollbar class = "myScrollBar"  :style="{ 'height': subMenuHeight(groupIndex)}" > 
          ...
          <div v-for="num, operationIndex in infoArry[3]"  
            ...
            @click.stop ="operationSelected($event, groupIndex, operationIndex)"
          >
 ...
 function  groupSelected(event:MouseEvent, groupIndex:number) {  
  ...
  function operationSelected(e: Event, groupIndex:number, operationIndex:number){
    // e.stopPropagation()
